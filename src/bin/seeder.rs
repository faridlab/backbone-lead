//! Database seeder binary for module: lead
//!
//! Generated by metaphor-schema. Do not edit manually.
//!
//! Run with: cargo run --bin lead-seeder
//! Or via CLI: backbone seed run --module lead
//!
...
// Import seeders
use backbone_lead::seeders::SeedLeadSeeder;
use backbone_lead::seeders::Seeder;
...
async fn main() -> Result<()> {
    ...
    println!();
    println!("Running seeders for module: lead");
    println!();

    // Register seeders in order
    let mut seeders: Vec<Box<dyn Seeder + Send + Sync>> = Vec::new();
    seeders.push(Box::new(SeedLeadSeeder::new()));
