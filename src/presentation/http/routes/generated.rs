...
use super::{
    lead_handler::create_lead_routes,
};
...
pub fn configure_routes(services: HttpServices) -> Router {
    Router::new()
        // Lead routes (12 Backbone endpoints)
        .merge(create_lead_routes(services.lead))
}
...
pub mod individual {
    ...
    pub fn lead_routes(service: Arc<LeadService>) -> Router {
